"""
╔══════════════════════════════════════════════════════════════════╗
║       Joseph Global Nigeria Limited — Python Backend             ║
...
class Config:
    ...
    COMPANY_EMAIL = "info@josephglobal.com.ng"   # ← Business email
    SEND_EMAILS = False   # ← Set True once email is configured

    # Company Info
    COMPANY_NAME    = "Joseph Global Nigeria Limited"
    ...
    ADMIN_EMAIL    = "admin@josephglobal.com.ng"
    ...
    if cursor.fetchone()[0] == 0:
        sample_testis = [
            ("Chief Balogun A.", "Homeowner, Lekki Phase 1", "BA", 5,
             "Joseph Global transformed our estate driveway completely. The workmanship was impeccable and they finished two days ahead of schedule.", "Lekki"),
